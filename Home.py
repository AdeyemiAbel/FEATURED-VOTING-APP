...
if __name__ == "__main__":
    ...
    about_text.grid(row=0,column=0,padx=(1,500), pady=(80,0), sticky='ne')
    help_text = ctk.CTkButton(bg_label,text='Help',text_color='Black',font=('Cooper Black',15),fg_color='white',width=50)
    help_text.grid(row=0,column=0,padx=(1,400), pady=(80,0), sticky='ne')
    method_text = ctk.CTkButton(bg_label,text='Methods',text_color='Black',font=('Cooper Black',15),fg_color='white',width=50)
    method_text.grid(row=0,column=0,padx=(1,300),pady=(80,0), sticky='ne')
    # blog_text = ctk.CTkButton(bg_label,text='Blog',text_color='Black',font=('Cooper Black',15),fg_color='white',width=50)
    # blog_text.grid(row=0,column=0,padx=(1,310), sticky='ne')
    # pricing_text = ctk.CTkButton(bg_label,text='Pricing',text_color='Black',font=('Cooper Black',15),fg_color='white',width=50)
    # pricing_text.grid(row=0,column=0,padx=(1,230), sticky='ne')
    ...
    #lbl_bg3 = ctk.CTkCanvas(option_frame)
    #lbl_bg3.create_line(1500,10,20000,10)
